...
penguins_combined <- list.files("data/penguin_distributions/",
  ...
  filter(penguins_combined, year == 2015)
split(penguins_combined, year(unique(uniq)))

  
uniq<- unique(penguins_combined$year) %>% 
  sort() 

%>% 
  map(penguins_combined, year)
